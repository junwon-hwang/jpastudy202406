...
//    @BeforeEach
    ...
    void changeTest () {
        ...
        /*
            ...
            해결방안은 데이터 수정시에 반대편 엔터티에도 같이 수정을 해야한다
         */
...
//        department.getEmployees().add(employee);
        ...
        employee.changDepartment(department);
    ...
    @Test
    @DisplayName("양방향관계에서 리스트 데이트를 추가하면 DB에도 INSERT된다")
...
//    }
    ...
    void nPlusOneTest() {
        ...
        for (Department dept : department) {
            ...
            System.out.println("사온 목록 가져옴" + employees.get(0).getName());
        }
