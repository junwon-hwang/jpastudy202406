...
class QueryDslGroupingTest {
    ...
    void ageGroupTest() {
        ...
        /*
            SELECT
                CASE age WHEN BETWEEN 10 AND 19 THAN 10
                CASE age WHEN BETWEEN 20 AND 29 THAN 20
                CASE age WHEN BETWEEN 30 AND 39 THAN 30
                END,
                COUNT(idol_id)
            FROM tbl_idol
            GROUP BY
